...
declare global {
  interface JSON {
    ...
    xstringify(value: any, replacer?: (this: any, key: string, value: any) => any, space?: string | number): string;
    xparse(text: string, reviver?: (this: any, key: string, value: any) => any): any;
  }
}
